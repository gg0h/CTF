...
my immediate thought is that the paragraph is different than the normal lorem ipsum paragraph, so I compared them

![comparison](comparison.png)

extracting all the different characters we get the flag
